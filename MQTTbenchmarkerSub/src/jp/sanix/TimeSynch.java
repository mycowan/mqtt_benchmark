...
public class TimeSynch {
     ...
     * 
     * and   time-d.nist.gov - All services via IPV6.
     */
...
//            
//            System.out.println("Sub Time from " + TIME_SERVER + " " + time + " : "
//                    + benchMarkTime);
//            System.out.println("Sub Time here " + System.currentTimeMillis());
//            
//            System.out.println("A difference of  " + (benchMarkTime - System.currentTimeMillis()));
